...
enum class RecitersEnum(val reciter : String, val url : String, val image : Int , val description : String) {
    ...
    Naser("ناصر القطامي","https://server6.mp3quran.net/qtm/",R.drawable.qtamy,"حفص عن عاصم - مرتل"),
    Yasser("ياسر الدوسري","https://server11.mp3quran.net/yasser/",R.drawable.dosri,"حفص عن عاصم - مرتل"),
